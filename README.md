...
<p align="center">
  ...
  <p align="center">
    An awsome webapplication to check the air pollution state in a few seconds !
    <br />
...
The project has the goal to verify the current air pollution state in a given location using API kindly provided us by the <b>World Air Quality Index Project.</b>
